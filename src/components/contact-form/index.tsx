...
import ImgHero43 from '~/media/assets/img/hero/hero-4-3.png?jsx';import { component$, useSignal, $ } from '@builder.io/qwik';
...
export default component$(() => {
  ...
  const formAction = $(async () => {
    try {
      ...
      console.error('A big error happened:', err);
      message.value = 'Failed to send message';
    ...
    <>
      ...
      >
        <div class="tp-contact-area tp-contact-overlay pt-120 pb-120 blue-bg z-index p-relative fix">
          <div class="tp-contact-glob-img" id="#">
            <ImgHero43 alt="" />
          </div>
          <div class="container">
            <div class="row">
              <div class="col-xl-5 col-12 z-index-3">
                <div class="tp-contact-section-box pb-25">
                  <h5 class="tp-section-subtitle-4 pb-10">CONTACT US</h5>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <a
                        ...
                        target="_blank"
                      >
                        Mwanga Tower, <br /> 6th Floor, Makumbusho, DSM Tanzania
                      </a>
                    </li>
                  </ul>
                </div>
                  ...
                  <div class="tp-contact-input-wrapper p-relative">
                    <div class="row">
                      ...
                      <div class="flex justify-center items-center w-100">
                        {message.value && (
                          <p class="text-white text-center">{message.value}</p>
                          )}
                      </div>
                        ...
                        <button
                          ...
                          class="btn-submit tp-btn-yellow-lg yellow-bg w-100"
                        >
                          {loading.value ? 'Sending...' : 'Get a free consultation'}
                        </button>
                      </div>
                    </div>
                  </div>
