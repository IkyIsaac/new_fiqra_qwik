  ...
  return (
    <main>
            ...
            <div className="col-xl-9 col-lg-7 col-md-7">
              <div className="price-banner z-index-3">
                <div className="price-banner-title-box">
                  <h3 className="price-banner-title tp-char-animation">
                    Pricing plans
                  </h3>
                      ...
                      <div className="col-4">
                        <div className="tp-price-header">
                          ...
                          <div className="tp-price-header-content">
                            <p>
                              You pay <span>$59.00/mo</span> today Renews <br />
                              April 2024 For <span>$69.00/mo</span>
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="tp-price-top-wrapper">
                          <div className="tp-price-top-item text-center">
                            <div className="tp-price-top-tag-wrapper">
                              <span>STARTER</span>
                              <p>
                                Collect more submissions, <br /> access most of
                                the features
                              </p>
                            </div>
                            <div className="tp-price-top-title-wrapper">
                              ...
                              <p>Billed monthly</p>
                              <a className="tp-btn-service" href="#">
                                Get Started
                              </a>
                            </div>
                          </div>
                              ...
                              <div className="d-flex align-items-center">
                                ...
                                <div className="tp-price-feature-tooltip-box p-relative">
                                  ...
                                  <div className="tp-price-feature-tooltip">
                                    <p>
                                      Add gradient heading, button, pricing
                                      table testimonial etc.
                                    </p>
                                  </div>
                                </div>
                              </div>
                        ...
                        <div className="col-4">
                          <div className="tp-price-feature-box">
                            <div className="tp-price-feature-item p-relative">
                              ...
                              <div className="tp-price-feature-tooltip">
                                <p>
                                  Add gradient heading, button, pricing table
                                  testimonial etc.
                                </p>
                              </div>
                            </div>
          ...
          <div className="row justify-content-center">
            <div className="col-xl-6">
              <div className="plan-section-box text-center pb-20">
                ...
                <p>
                  Comparing our pricing plans side-by-side so you can choose the
                  best <br /> one for yourself.
                </p>
              </div>
            </div>
          </div>
          <div className="pr-feature-box">
            <div className="pr-feature-main">
                  ...
                  <div className="col-xl-8 col-lg-8 col-md-8">
                    <div className="pr-feature-head">
                      <ul>
                        ...
                        <li>
                          <div className="pr-feature-item active">
                            <h5>Growth</h5>
                            <a
                              className="tp-btn-service black-bg text-white"
                              href="service-details.html"
              ...
              <div className="pr-feature-wrapper-2">
                <div className="row gx-0 align-items-center pr-feature-height">
                  <div className="col-xl-4 col-lg-4 col-md-4">
                    <div className="pr-feature-bottom">
                      <div className="pr-feature-title-box">
                        <h5 className="pr-feature-title-sm">Version history</h5>
                      </div>
                    </div>
                  </div>
                  <div className="col-xl-8 col-lg-8 col-md-8">
                ...
                <div className="row gx-0 align-items-center pr-feature-height">
                  <div className="col-xl-4 col-lg-4 col-md-4">
                    <div className="pr-feature-bottom">
                      <div className="pr-feature-title-box">
                        <h5 className="pr-feature-title-sm">
                ...
                <div className="row gx-0 align-items-center pr-feature-height">
                  <div className="col-xl-4 col-lg-4 col-md-4">
                    <div className="pr-feature-bottom">
                      <div className="pr-feature-title-box">
                        <h5 className="pr-feature-title-sm">Cross platform</h5>
                      </div>
                    </div>
                  </div>
                  <div className="col-xl-8 col-lg-8 col-md-8">
                ...
                <div className="row gx-0 align-items-center pr-feature-height">
                  <div className="col-xl-4 col-lg-4 col-md-4">
                    <div className="pr-feature-bottom">
                      <div className="pr-feature-title-box">
                        <h5 className="pr-feature-title-sm">Storage</h5>
                      </div>
                    </div>
                  </div>
                  <div className="col-xl-8 col-lg-8 col-md-8">
                ...
                <div className="row gx-0 align-items-center pr-feature-height">
                  <div className="col-xl-4 col-lg-4 col-md-4">
                    <div className="pr-feature-bottom">
                      <div className="pr-feature-title-box">
                        <h5 className="pr-feature-title-sm">Collaboration</h5>
                      </div>
                    </div>
                  </div>
                  <div className="col-xl-8 col-lg-8 col-md-8">
                ...
                <div className="row gx-0 align-items-center pr-feature-height">
                  <div className="col-xl-4 col-lg-4 col-md-4">
                    <div className="pr-feature-bottom">
                      <div className="pr-feature-title-box">
                        <h5 className="pr-feature-title-sm">
                          Unlimited single-use virtual cards
                        </h5>
                      </div>
                    </div>
                  </div>
      ...
      <div
        ...
        data-background="assets/img/testimonial/testi-bg-5-1.jpg"
      >
        <div className="container">
                        ...
                        <div className="tp-testimonial-five-wrapper d-flex justify-content-between align-items-center">
                          <div className="tp-testimonial-five-top-info d-flex align-items-center">
                            <div className="tp-testimonial-five-avata">
                              <img
                                src="assets/img/testimonial/testi-icon-5-4.png"
                                alt=""
                              />
                            </div>
                          ...
                          <div className="tp-testimonial-five-brand d-none d-sm-block">
                            <img
                              src="assets/img/testimonial/testi-logo-5-2.png"
                              alt=""
                            />
                          </div>
                        </div>
                      ...
                      <div className="tp-testimonial-five-item">
                        <div className="tp-testimonial-five-wrapper d-flex justify-content-between align-items-center">
                          <div className="tp-testimonial-five-top-info d-flex align-items-center">
                            <div className="tp-testimonial-five-avata">
                              <img
                                src="assets/img/testimonial/testi-icon-5-2.png"
                                alt=""
                              />
                            </div>
                            <div className="tp-testimonial-five-author-info">
                          ...
                          <div className="tp-testimonial-five-brand d-none d-sm-block">
                            <img
                              src="assets/img/testimonial/testi-logo-5-1.png"
                              alt=""
                            />
                          </div>
                        </div>
                      ...
                      <div className="tp-testimonial-five-item">
                        <div className="tp-testimonial-five-wrapper d-flex justify-content-between align-items-center">
                          <div className="tp-testimonial-five-top-info d-flex align-items-center">
                            <div className="tp-testimonial-five-avata">
                              <img
                                src="assets/img/testimonial/testi-icon-5-3.png"
                                alt=""
                              />
                            </div>
                            <div className="tp-testimonial-five-author-info">
                          ...
                          <div className="tp-testimonial-five-brand d-none d-sm-block">
                            <img
                              src="assets/img/testimonial/testi-logo-5-3.png"
                              alt=""
                            />
                          </div>
                        </div>
                      ...
                      <div className="tp-testimonial-five-item">
                        <div className="tp-testimonial-five-wrapper d-flex justify-content-between align-items-center">
                          <div className="tp-testimonial-five-top-info d-flex align-items-center">
                            <div className="tp-testimonial-five-avata">
                              <img
                                src="assets/img/testimonial/testi-icon-5-1.png"
                                alt=""
                              />
                            </div>
                            <div className="tp-testimonial-five-author-info">
