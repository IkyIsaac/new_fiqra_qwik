   ...
   <div class="container">
      ...
      <div class="row">
         <div class="col-xl-8 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
            <div class="tp-service-3-item mb-30 p-relative z-index" data-background="/assets/img/cta/cta-bg.png">
                  ...
                  <div class="accordion-items">
                     ...
                     <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                           The Fiqra Shop is built right into your account dashboard, and is accessible
