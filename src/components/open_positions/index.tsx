        ...
        <div class="row">
          <div class="col-xl-12">
            <div class="job-section-box text-center mb-40">
              ...
              <p>
                Fiqra Technologies attracts people who are eager to work
                together and grow together. Does this sound like you?
                <br /> We are excited to meet you!{" "}
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="col-lg-5 col-md-4">
              <div class="job-post-info d-flex justify-content-start align-items-center">
                <div class="job-post-category">
                  <span class="py-10">Instructional Designer</span>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-3">
              <div class="job-post-apply-btn text-start text-md-end">
                <a
                  ...
                  href="/careers/instructional_designer"
                >
                  <span>Apply</span> <b></b>
                </a>
              </div>
        ...
        <div class="job-post-box">
          <div class="row align-items-center">
            <div class="col-lg-5 col-md-4">
              <div class="job-post-info d-flex justify-content-start align-items-center">
                <div class="job-post-category">
                  <span class="py-10">Business Development Manager</span>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-5">
            ...
            <div class="col-lg-3 col-md-3">
              <div class="job-post-apply-btn text-start text-md-end">
                <a
                  class="tp-btn-inner tp-btn-hover alt-color-orange"
                  href="/careers/business_developer/"
                >
                  <span>Apply</span> <b></b>
                </a>
              </div>
        ...
        <div class="job-post-box">
          <div class="row align-items-center">
            <div class="col-lg-5 col-md-4">
              <div class="job-post-info d-flex justify-content-start align-items-center">
                <div class="job-post-category">
                  <span class="py-10">Marketing Intern</span>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-5">
