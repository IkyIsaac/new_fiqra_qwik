         ...
         <div class="col-xl-5 col-lg-5 career-details-pin">
            ...
            <div class="col-xxl-12">
               ...
               <div class="career-details-bottom-text text-center">
                  <a href="/career">Employee at Fiqra?</a>
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="row">
         <div class="col-xl-12">
            <div class="job-section-box text-center mb-40">
               ...
               <p>Fiqra Technologies attracts people who are eager to work together and grow together. Does this sound like you?<br/>
               We are excited to meet you!</p>
            </div>
         </div>
      </div>
            ...
            <div class="col-lg-5 col-md-4">
               <div class="job-post-info d-flex justify-content-start align-items-center">
                  <div class="job-post-category">
                     <span>E-Learning Developer and<br/><br/>  Instructional Designer</span>
                  </div>
               </div>
            </div>
