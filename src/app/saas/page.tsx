    ...
    <main className="fix">
      <div className="tp-hero-area tp-hero-five__ptb-5 p-relative grey-bg-2 fix">
        <div className="tp-hero-five__shape-2">
          <img src="/img/hero/hero-circle-5-1.png" alt="" />
        </div>
        <div className="tp-hero-five__shape-3">
          <img src="/img/hero/hero-circle-5-2.png" alt="" />
        </div>
        <div className="tp-hero-five__shape-4">
          <img src="/img/hero/hero-circle-5-3.png" alt="" />
        </div>
            ...
            <div className="col-xl-7 col-lg-6 order-2">
              <div className="tp-hero-five-section-wrap">
                ...
                >
                  ...
                  <a className="tp-btn-grey mb-20" href="service-details.html">
                    Try a Demo
                  </a>
                </div>
              </div>
        ...
        <div className="tp-hero-five-2-thumb-main p-relative">
          <div className="tp-hero-five-2-thumb">
            <img
              ...
              src="/img/hero/hero-shape-5-1-1.png"
              alt=""
            />
          </div>
            ...
            <div className="col-12">
              <div className="tp-vedio-wrap">
                <a
                  ...
                  href="https://www.youtube.com/watch?v=_RpLvsA1SNM"
                >
                  <video className="play-video" id="myVideo" autoPlay loop>
                    <source
                      src="https://html.hixstudio.net/videos/Fiqra/Fiqra-video.mp4"
                      type="video/mp4"
                    />
                  </video>
                </a>
      ...
      <div className="tp-service-area tp-services-five-item-bg-color p-relative fix">
        <div className="container-fluid p-0">
          <div
            ...
            data-background="/img/service/service-5-1-bg.png"
          ></div>
              ...
              <div className="row g-0">
                  ...
                  <div className="tp-service-five-item z-index">
                    ...
                    <div className="tp-service-five-wrapper">
                      <div className="tp-service-five-icon">
                        <img src="/img/service/sv-icon-5-1.png" alt="" />
                      </div>
                      <div className="tp-service-five-content">
                        ...
                        <p>
                          Track materials and stock for outsourced purchase
                          orders
                        </p>
                      </div>
                    </div>
                ...
                <div className="col-md-6">
                  <div className="tp-service-five-item z-index">
                    ...
                    <div className="tp-service-five-wrapper">
                      <div className="tp-service-five-icon">
                        <img src="/img/service/sv-icon-5-2.png" alt="" />
                      </div>
                      <div className="tp-service-five-content">
                        <h3 className="tp-service-five-title-sm">
                          <a href="service-details.html">
                ...
                <div className="col-md-6">
                  <div className="tp-service-five-item z-index">
                    ...
                    <div className="tp-service-five-wrapper">
                      <div className="tp-service-five-icon">
                        <img src="/img/service/sv-icon-5-3.png" alt="" />
                      </div>
                      <div className="tp-service-five-content">
                        <h3 className="tp-service-five-title-sm">
                          <a href="service-details.html">
                ...
                <div className="col-md-6">
                  <div className="tp-service-five-item z-index">
                    ...
                    <div className="tp-service-five-wrapper">
                      <div className="tp-service-five-icon">
                        <img src="/img/service/sv-icon-5-4.png" alt="" />
                      </div>
                      <div className="tp-service-five-content">
                        <h3 className="tp-service-five-title-sm">
                          <a href="service-details.html">
          ...
          <div className="row align-items-center">
            ...
            >
              <div className="tp-plan-section-box">
                ...
                <h3 className="tp-section-title-5 text-black pb-15">
                ...
                <div className="tp-plan-feature">
                  <ul>
                    <li>
                      <i className="far fa-check"></i>Billable
                    </li>
                    <li>
                      <i className="far fa-check"></i>Manual time entries
                    </li>
                    <li>
                      <i className="far fa-check"></i>Services
                    </li>
                  </ul>
                </div>
              </div>
                      ...
                      <div className="tp-testimonial-five-item">
                        ...
                        <div className="tp-testimonial-five-content">
                          <p>
                            ...
                            suffering from this service in different platform
                            and the lovers are always looking this kind of
                            feature on their own website. ”
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div className="row">
            <div className="col-12">
              <div className="tp-feature-five-section-box text-center mb-40">
                ...
                <p>
                  Take your business to the next level with <span>09</span>{" "}
                  accessible premium extensions <br />& different features
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-12">
              <div className="tp-feature-five-link text-center">
                <span>
                  ...
                  <a href="service-details.html">All features</a>
                </span>
              </div>
            </div>
          </div>
              ...
              <div className="tp-intigration-five-wrapper p-relative">
                <div className="tp-intigration-five-section-box text-center">
                  ...
                  <p>
                    ...
                    <br /> popular media all over the world.
                  </p>
      ...
      <div
        ...
        data-background="/img/cta/cta-bg-5-1.png"
      >
