          ...
          <div className="row align-items-center">
            <div className="col-xl-3 col-lg-3 col-md-6">
              <div className="carrer-banner-img-item">
                <img src="/img/career/image-1.png" alt="" />
              </div>
            </div>
            ...
            <div className="col-xl-3 col-lg-3 d-none d-lg-block">
              <div className="carrer-banner-img-item mb-20">
                <img src="/img/career/image-3.png" alt="" />
              </div>
              <div className="carrer-banner-img-item">
                <img src="/img/career/image-4.png" alt="" />
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div className="col-custom">
                    ...
                    <div className="tp-panel-item-2">
                      <div className="tp-panel-content-2">
                        ...
                        <p>
                          Blocks infected website tracking programs and
                          annoying.
                        </p>
                      </div>
                    </div>
