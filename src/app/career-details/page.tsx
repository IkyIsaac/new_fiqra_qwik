          ...
          <div className="row align-content-start">
              ...
              <div className="career-details-wrapper">
                ...
                <div className="career-details-job-responsiblity mb-45">
                  ...
                  <p>
                    ...
                    passage of Lorem Ipsum,anything embarrassing hidden.
                  </p>
                </div>
                <div className="career-details-job-responsiblity mb-45">
                ...
                <div className="career-details-job-responsiblity mb-45">
                  ...
                  <p className="pb-15">
                    Now, the paradigm has shifted. The question is not why you
                    should include a content marketing strategy.
                  </p>
                  <div className="career-details-job-list">
                    <ul>
                      <li>
                ...
                <div className="career-details-job-responsiblity mb-20">
                  ...
                  <div className="career-details-job-list">
                    <ul>
                      <li>
                        <i className="fal fa-long-arrow-right"></i>
                        Experience building software and systems that balance{" "}
                        <br /> simplicity, flexibility, and security.
                      </li>
                      <li>
                        <i className="fal fa-long-arrow-right"></i>
                        Track record with a smart contract language <br /> such
                        as Solidity
                      </li>
                      <li>
                        <i className="fal fa-long-arrow-right"></i>A
                        customer-focused and product-focused mindset.
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="career-details-job-responsiblity">
                  ...
                  <p>
                    TBachelors Degree in Interaction, Graphic Design, Media Arts
                    or similar.
                  </p>
                </div>
              </div>
            ...
            <div className="col-xl-5 col-lg-5 career-details-pin">
              ...
              <div id="show" className="career-details-hide-wrapper">
                {/* style="display: none;" belonged to the div above */}
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="job-section-box text-center mb-40">
                ...
                <p>
                  Borem ipsum dolor sit amet, consectetur adipiscing elit. Nulla
                  scelerisque tristique <br />
