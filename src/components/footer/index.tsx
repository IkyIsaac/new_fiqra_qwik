...
import ImgFooterBottomShape41 from '~/media/assets/img/footer/footer-bottom-shape-4-1.png?jsx';import { component$ } from '@builder.io/qwik';
...
<div class="tp-footer__pl-pr blue-bg z-index">
        <div class="tp-footer__area tp-footer__border-bottom-4 fix">
          <div class="tp-footer-bottom-shape">
            <ImgFooterBottomShape41 alt="" />
          </div>
          <div class="container">
            <div class="row">
              <div
                class="col-xl-4 col-lg-4 col-md-6 pb-45 wow tpfadeUp"
              ...
              <div
                class="col-xl-5 col-lg-5 col-md-6 pb-45 wow tpfadeUp"
                data-wow-duration=".9s"
                data-wow-delay=".5s"
              >
              ...
              <div
                class="col-xl-3 col-lg-3 col-md-6 pb-45 wow tpfadeUp"
                data-wow-duration=".9s"
                data-wow-delay=".7s"
              >
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <a
                          ...
                          target="_blank"
                        >
                          Mwanga Tower, <br /> 6th Floor, Makumbusho, DSM
                          Tanzania
                        </a>
                      </li>
                    </ul>
        ...
        <div
          class="tp-copyright__area pt-20 pb-20 wow tpfadeUp"
          data-wow-duration=".9s"
          data-wow-delay=".9s"
        >
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="tp-copyright__text tp-copyright__text-4 text-center">
                  <span>
                    {" "}
                    <a href="https://fiqra.academy/">Fiqra Technologies </a>{" "}
