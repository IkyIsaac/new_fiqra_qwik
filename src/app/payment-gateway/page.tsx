  ...
  return (
    <main className="fix">
      <div
        ...
        data-background="/img/hero/hero-bg-2.png"
      >
        <div className="scroll-bg d-none d-sm-block">
          <img src="/img/hero/scroll-down.png" alt="" />
        </div>
            ...
            <div className="col-xl-6 col-lg-6">
              ...
              <div className="tp-hero-2__user p-relative">
                ...
                <div className="tp-hero-2__user-img">
                  <img src="/img/hero/hero-user.jpg" alt="" />
                </div>
                ...
                <div className="col-md-6 mb-30">
                  ...
                  >
                    ...
                    <div className="tp-payment__shape-11">
                      <img src="/img/payment/message.png" alt="" />
                    </div>
                    <div className="tp-payment__content">
                      <h3 className="tp-payment__title">
                        Easily Send Requesrs vai e-mail or SMS
                      </h3>
            ...
            <div className="col-xl-12 mb-30">
              ...
              >
                <div className="tp-payment__shape-1">
                  <img src="/img/payment/background.png" alt="" />
                </div>
                <div className="row">
                  <div className="col-md-6">
                    <div className="tp-payment__content tp-payment__content-space">
                      ...
                      <p>
                        Get paid faster with Online Invoicing <br /> and the
                        Virtual Terminal.
                      </p>
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="tp-payment__shape-3 d-none d-sm-block">
                      <img src="/img/payment/get-paid.png" alt="" />
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="tp-service-2__area p-relative pt-70 pb-160">
        <div className="tp-service-2__shape">
          <img src="/img/service/sv-bg-2-1.jpg" alt="" />
        </div>
          ...
          <div className="row gx-60">
              ...
              <div className="tp-service-2__item-wrapper p-relative">
                <div className="tp-service-2__item d-flex justify-content-between flex-column">
                  <div className="tp-service-2__icon">
                    <img src="/img/service/sv-icon-2-1.png" alt="" />
                  </div>
                  <div className="tp-service-2__text">
                    <h4 className="tp-service-2__title-sm">
                      <a href="service-details.html">Online</a>
                    </h4>
                    <a
                ...
                <div className="tp-service-2__bg-shape"></div>
              </div>
            </div>
            <div
              className="col-xl-3 col-lg-3 col-md-6 mb-40 wow tpfadeUp"
            ...
            >
              <div className="tp-service-2__item-wrapper p-relative">
                <div className="tp-service-2__item d-flex justify-content-between flex-column">
                  ...
                  <div className="tp-service-2__text">
                    <h4 className="tp-service-2__title-sm">
                      <a href="service-details.html">Bank Transfers</a>
                    </h4>
                    <a
                      className="tp-service-2__link"
                      href="service-details.html"
            ...
            >
              <div className="tp-service-2__item-wrapper p-relative">
                <div className="tp-service-2__item d-flex justify-content-between flex-column">
                  <div className="tp-service-2__icon">
                    <img src="/img/service/sv-icon-2-3.png" alt="" />
                  </div>
                  <div className="tp-service-2__text">
                    <h4 className="tp-service-2__title-sm">
                      <a href="service-details.html">Keyed</a>
                    </h4>
                    <a
                      className="tp-service-2__link"
                      href="service-details.html"
            ...
            >
              <div className="tp-service-2__item-wrapper p-relative">
                <div className="tp-service-2__item  d-flex justify-content-between flex-column">
                  <div className="tp-service-2__icon">
                    <img src="/img/service/sv-icon-2-4.png" alt="" />
                  </div>
                  <div className="tp-service-2__text">
                    <h4 className="tp-service-2__title-sm">
                      <a href="service-details.html">In-Person</a>
                    </h4>
                    <a
                      className="tp-service-2__link"
                      href="service-details.html"
            ...
            <div className="col-xl-6 col-lg-6">
              ...
              >
                <div className="tp-account-bg">
                  <img src="/img/account/account-bg.png" alt="" />
                </div>
                <div className="tp-account-main-img">
                  <img src="/img/account/acc-main.png" alt="" />
                </div>
                <div className="tp-account-author">
                  <img src="/img/account/ac-author.png" alt="" />
                </div>
                <div className="tp-account-shape-1">
                  <img src="/img/account/ac-shape-1.png" alt="" />
                </div>
                <div className="tp-account-shape-2">
                  <img src="/img/account/ac-shape-2.png" alt="" />
                </div>
              </div>
            </div>
            <div className="col-xl-6 col-lg-6">
              <div className="tp-account-step-wrapper">
                ...
                <div className="tp-account-step mb-50">
                  ...
                  <div className="tp-account-item d-flex align-items-center">
                    <span>03</span>
                    <p>
                      Your account is open; you can send <br /> your first
                      payment
                    </p>
                  </div>
                </div>
                <div className="tp-account-btn-box">
                  <a className="tp-btn-green mb-15" href="register.html">
      ...
      <div
        ...
        data-background="/img/testimonial/testi-bg-2-1.png"
      >
        <div className="container">
          <div className="row justify-content-center">
                  ...
                  <div>
                    ...
                    >
                      <div className="tp-testimonial-2-border-shape">
                        <img src="/img/testimonial/BODY.png" alt="" />
                      </div>
                      ...
                      <div className="tp-testimonial-2-content">
                        <p>
                          "Is it possible to Love your credit card processor?
                          with Fiqra, yes!"
                        </p>
                      </div>
                      <div className="tp-testimonial-2-author d-flex align-items-center">
                        <div className="tp-testimonial-2-img">
                          <img
                            src="/img/testimonial/testi-icon-2-1.png"
                            alt=""
                          />
                        </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <div className="tp-testimonial-2-author d-flex align-items-center">
                        <div className="tp-testimonial-2-img">
                          <img
                            src="/img/testimonial/testi-icon-2-2.png"
                            alt=""
                          />
                        </div>
                        <div className="tp-testimonial-2-author-info">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <div className="tp-testimonial-2-author d-flex align-items-center">
                        <div className="tp-testimonial-2-img">
                          <img
                            src="/img/testimonial/testi-icon-2-3.png"
                            alt=""
                          />
                        </div>
                        <div className="tp-testimonial-2-author-info">
            ...
            <div className="col-xl-6 col-lg-6">
              <div className="tp-faq-left-wrapper p-relative">
                ...
                <div className="tp-faq-btn">
                  <a className="tp-btn-green" href="contact.html">
                    Get in Touch
                  </a>
                </div>
                <div
                  ...
                  <div className="accordion-items">
                    ...
                    >
                      <div className="accordion-body">
                        The Fiqra Shop is built right into your account
                        dashboard, and is accessible immediately after signing
                        up.
                      </div>
                    </div>
                  </div>
            ...
            <div className="col-12">
              <div className="tp-cta-bg" data-background="/img/cta/cta-bg.jpg">
                <div className="tp-cta-content text-center">
                  ...
                  <a className="tp-btn-green" href="service-details.html">
                    Get Started Now
                  </a>
                </div>
              </div>
