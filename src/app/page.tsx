                  ...
                  <div className="col-4">
                    <div className="tp-price-header">
                      <div className="tp-price-header-img">
                        <img src="/img/price/price-4.1.png" alt="" />
                      </div>
                    ...
                    <div className="tp-price-top-wrapper">
                      <div className="tp-price-top-item text-center">
                        <div className="tp-price-top-tag-wrapper">
                          <span>STARTER</span>
                          <p>
                            Collect more submissions, <br /> access most of the
                            features
                          </p>
                        </div>
                        <div className="tp-price-top-title-wrapper">
                          <h4>
                            <em>$</em>18 <span>/mo</span>
                          </h4>
                          <p>Billed monthly</p>
                          <a className="tp-btn-service" href="price.html">
                            Get Started
                          </a>
                        </div>
                      </div>
