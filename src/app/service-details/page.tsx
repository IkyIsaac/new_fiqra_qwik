            ...
            <div className="col-xl-8 col-lg-8">
              <div className="sv-details-wrapper">
                <div className="sv-details-thumb mb-45">
                  <img
                    className="w-100"
                    src="/img/service/sv-details-1.jpg"
                    alt=""
                  />
                </div>
                  ...
                  <ul>
                    <li>
                      ...
                      <p>
                        Product Quality: <br />
                        <span>
                          Automatically syncs across all your devices. You can
                          also access....
                        </span>
                      </p>
                    </li>
                    ...
                    <li>
                      ...
                      <p>
                        Choice of Service:
                        <span>
                          Whatever your business needs, you can choose a
                          service.
                        </span>
                      </p>
                    </li>
                            ...
                            <div className="accordion-items">
                              ...
                              >
                                <div className="accordion-body">
                                  The Fiqra Shop is built right into your
                                  account dashboard, and is accessible
