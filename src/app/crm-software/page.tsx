    ...
    <main className="fix">
      <div className="tp-hero-area tp-hero-pt pt-170 pb-70 p-relative">
        <div className="tp-hero-left-shape">
          <img src="/img/hero/hero-left-shape-3-1.png" alt="" />
        </div>
        <div className="tp-hero-gradient-bg">
          <img src="/img/hero/hero-gradient-3.jpg" alt="" />
        </div>
            ...
            <div className="col-xl-11">
              <div className="tp-hero-title-box text-center">
                <h2 className="tp-hero-title-3 hero-text-anim pb-5">
                  ...
                  <i>
                    <i className="child-1">Relationships Start Here.</i>
                  </i>
                </h2>
                <p className=" tp-char-animation-2">
                  Fiqra provides all customer management service within one
                  software. <br /> Our landing works on all devices.
                </p>
              </div>
              <div
              ...
              >
                <div className="tp-hero-browser-item">
                  <a href="#">
                    <img src="/img/hero/browser-icon-1.png" alt="" />
                  </a>
                  <p className="d-none d-sm-block">Windows</p>
                </div>
                <div className="tp-hero-browser-item">
                  <a href="#">
                    <img src="/img/hero/browser-icon-2.png" alt="" />
                  </a>
                  <p className="d-none d-sm-block">Firefox</p>
                </div>
                <div className="tp-hero-browser-item">
                  <a href="#">
                    <img src="/img/hero/browser-icon-3.png" alt="" />
                  </a>
                  <p className="d-none d-sm-block">Chrome</p>
                </div>
                <div className="tp-hero-browser-item">
                  <a href="#">
                    <img src="/img/hero/browser-icon-4.png" alt="" />
                  </a>
                  <p className="d-none d-sm-block">macOS</p>
                </div>
                <div className="tp-hero-browser-item">
                  <a href="#">
                    <img src="/img/hero/browser-icon-5.png" alt="" />
                  </a>
                  <p className="d-none d-sm-block">Linux</p>
                </div>
              </div>
              <div className="tp-hero-3-wrapper p-relative">
                ...
                <div className="tp-hero-3-main-thumb z-index-5">
                  <img src="/img/hero/hero-img-3-1.png" alt="" />
                </div>
                <div className="tp-hero-3-shape-5 d-none d-lg-block wow frist-img animated">
                  <img src="/img/hero/hero-img-3-1-3.png" alt="" />
                </div>
      ...
      <div className="tp-counter-area tp-counter-space p-relative pb-140">
        <div className="tp-counter-shape-2">
          <img src="/img/counter/counter-shape-2.png" alt="" />
        </div>
        <div className="tp-counter-shape-3">
          <img src="/img/counter/counter-shape-1.png" alt="" />
        </div>
        <div className="tp-counter-shape-4 d-none d-sm-block">
          <img src="/img/counter/counter-shape-4.png" alt="" />
        </div>
        <div className="container">
          ...
          <div className="row">
            ...
            >
              <div
                ...
                data-background="/img/service/service-3-bg.png"
              >
                <div className="tp-service-3-icon">
                  <img src="/img/service/sv-icon-3-1.png" alt="" />
                </div>
                <div className="tp-service-3-content">
                  <span>CRM Management</span>
                  <h4 className="tp-service-3-title-sm">
                    <a href="service-details.html">
                      Generate, Manage, and Convert leads <br /> into Customers.
                      Automatically
                    </a>
                  </h4>
                </div>
                <div className="tp-service-3-btn">
                  <a className="tp-btn-white-solid" href="service-details.html">
                    Learn More
                  </a>
                </div>
            ...
            <div
              className="col-xl-4 col-lg-6 col-md-6 wow tpfadeRight"
              data-wow-duration=".9s"
              data-wow-delay=".6s"
            >
              ...
              <div className="tp-service-sm-item mb-30 d-flex flex-column justify-content-between">
                <div className="tp-service-sm-icon">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M21.0604 25.7002C20.7846 25.3913 20.3104 25.3644 20.0015 25.6403C19.6925 25.9162 19.6657 26.3903 19.9415 26.6993L21.0604 25.7002ZM24.7867 30.9998L24.2272 31.4993C24.3695 31.6586 24.573 31.7498 24.7867 31.7498C25.0003 31.7498 25.2038 31.6586 25.3461 31.4993L24.7867 30.9998ZM36.0604 19.4993C36.3363 19.1903 36.3095 18.7162 36.0005 18.4403C35.6915 18.1644 35.2174 18.1913 34.9415 18.5002L36.0604 19.4993ZM19.9415 26.6993L24.2272 31.4993L25.3461 30.5002L21.0604 25.7002L19.9415 26.6993ZM25.3461 31.4993L36.0604 19.4993L34.9415 18.5002L24.2272 30.5002L25.3461 31.4993Z"
                      fill="CurrentColor"
                    />
                    <path
      ...
      <div className="tp-rated-area fix p-relative">
        <div
          ...
          data-background="/img/rate/rated-bg.jpg"
        >
          <div className="tp-rated-shape-1 d-none d-lg-block">
            <img src="/img/rate/rate-shape-1.png" alt="" />
          </div>
          <div className="tp-rated-shape-2 d-none d-sm-block">
            <img src="/img/rate/rate-shape-2.png" alt="" />
          </div>
          <div className="container z-index-6">
              ...
              <div className="col-xl-10">
                <div className="tp-rated-title-box text-center mb-60">
                  ...
                  <h5 className="tp-section-title-3 text-white pb-40">
                    ...
                    <br /> <span>Rated</span> Fiqra<span> 4.9/5</span>
                  </h5>
                  <a
                ...
                <div className="col-xl-4 col-lg-4 col-md-4">
                  <div className="author-rated text-center">
                    ...
                    <div className="author-rated-logo">
                      <img src="/img/rate/rate-logo-1.png" alt="" />
                    </div>
                  </div>
                </div>
                <div className="col-xl-4 col-lg-4 col-md-4">
                  <div className="author-rated text-center">
                    ...
                    <div className="author-rated-logo">
                      <img src="/img/rate/rate-logo-2.png" alt="" />
                    </div>
                  </div>
                </div>
                <div className="col-xl-4 col-lg-4 col-md-4">
                  <div className="author-rated text-center">
                    ...
                    <p>"the interface is excellent"</p>
                    <div className="author-rated-logo">
                      <img src="/img/rate/rate-logo-3.png" alt="" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div
              className="author-rated-big-img"
              data-parallax='{"y": 100, "smoothness": 30}'
            >
              <img src="/img/rate/rated-img.png" alt="" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="row">
            ...
            >
              <div className="tp-card-title-box">
                ...
                <p className="">
                  Digital products are where it’s at! There are so many benefits
                  to selling digital products. It’s easy to get started and they{" "}
                  <br />
              ...
              <div className="tp-sales-feature">
                <ul>
                  ...
                  <li className="green-3">
                    <span>
                      <i className="far fa-check"></i>{" "}
                      <em>No training or maintenance needed</em>
                    </span>
                  </li>
                </ul>
              </div>
            ...
            >
              <div className="tp-sales-img-wrapper p-relative text-end">
                <div className="tp-sales-main-thumb">
                  <img src="/img/card/sale-1.png" alt="" />
                </div>
                <div className="tp-sales-sub-img-1">
                  <img src="/img/card/sale-2.png" alt="" />
                </div>
                <div className="tp-sales-sub-img-2 d-none d-sm-block">
                  <img src="/img/card/sale-3.png" alt="" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="tp-testimonial-area tp-testimonial-3-mlr pb-110">
        <div
          ...
          data-background="/img/testimonial/testi-bg-3-1.png"
        >
          <div className="container">
            <div className="row">
                    ...
                    <div className="tp-testimonial-wrapper">
                      <div className="tp-testimonial-3-item d-flex justify-content-between align-items-center">
                        <div className="tp-testimonial-3-content-box">
                          ...
                          <div className="tp-testimonial-3-author-info d-flex align-items-center">
                            <div className="tp-testimonial-3-sm-thumb d-md-none">
                              <img
                                src="/img/testimonial/testi-3-2.png"
                                alt=""
                              />
                            </div>
                            <div>
                        ...
                        <div className="tp-testimonial-3-thumb d-none d-md-block">
                          <img src="/img/testimonial/testi-3-2.png" alt="" />
                        </div>
                      </div>
                    </div>
                    <div className="tp-testimonial-wrapper">
                      <div className="tp-testimonial-3-item d-flex justify-content-between align-items-center">
                        <div className="tp-testimonial-3-content-box">
                          ...
                          <div className="tp-testimonial-3-author-info d-flex align-items-center">
                            <div className="tp-testimonial-3-sm-thumb d-md-none">
                              <img
                                src="/img/testimonial/testi-3-3.png"
                                alt=""
                              />
                            </div>
                            <div>
                        ...
                        <div className="tp-testimonial-3-thumb d-none d-md-block">
                          <img src="/img/testimonial/testi-3-3.png" alt="" />
                        </div>
                      </div>
                    </div>
                    <div className="tp-testimonial-wrapper">
                      <div className="tp-testimonial-3-item d-flex justify-content-between align-items-center">
                        <div className="tp-testimonial-3-content-box">
                          ...
                          <p>
                            “Softuch helps me keep a clean, organized ledger
                            that I can access anywhere. The UI is so intuitive
                            that anyone can use it,
                          </p>
                          <div className="tp-testimonial-3-author-info d-flex align-items-center">
                            <div className="tp-testimonial-3-sm-thumb d-md-none">
                              <img
                                src="/img/testimonial/testi-3-4.png"
                                alt=""
                              />
                            </div>
                            <div>
                        ...
                        <div className="tp-testimonial-3-thumb d-none d-md-block">
                          <img src="/img/testimonial/testi-3-4.png" alt="" />
                        </div>
                      </div>
                    </div>
                    <div className="tp-testimonial-wrapper">
                      <div className="tp-testimonial-3-item d-flex justify-content-between align-items-center">
                        <div className="tp-testimonial-3-content-box">
                          ...
                          <div className="tp-testimonial-3-author-info d-flex align-items-center">
                            <div className="tp-testimonial-3-sm-thumb d-md-none">
                              <img
                                src="/img/testimonial/testi-3-5.png"
                                alt=""
                              />
                            </div>
                            <div>
                        ...
                        <div className="tp-testimonial-3-thumb d-none d-md-block">
                          <img src="/img/testimonial/testi-3-5.png" alt="" />
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <div className="tp-integration-area pb-110 tp-integration-mlr">
        ...
        <div
          ...
          data-background="/img/integration/integration-bg.jpg"
        >
          <div className="tp-integration-slider-active">
            <div className="tp-integration-slider-main">
              <div className="tp-integration-slider-item">
                <img src="/img/integration/integration-1.png" alt="" />
              </div>
            </div>
            <div className="tp-integration-slider-main">
              <div className="tp-integration-slider-item">
                <img src="/img/integration/integration-2.png" alt="" />
              </div>
            </div>
            <div className="tp-integration-slider-main">
              <div className="tp-integration-slider-item">
                <img src="/img/integration/integration-3.png" alt="" />
              </div>
            </div>
            <div className="tp-integration-slider-main">
              <div className="tp-integration-slider-item">
                <img src="/img/integration/integration-4.png" alt="" />
              </div>
            </div>
          </div>
          <div
          ...
          >
            <div className="tp-integration-slider-main">
              <div className="tp-integration-slider-item">
                <img src="/img/integration/integration-5.png" alt="" />
              </div>
            </div>
            <div className="tp-integration-slider-main">
              <div className="tp-integration-slider-item">
                <img src="/img/integration/integration-6.png" alt="" />
              </div>
            </div>
            <div className="tp-integration-slider-main">
              <div className="tp-integration-slider-item">
                <img src="/img/integration/integration-7.png" alt="" />
              </div>
            </div>
            <div className="tp-integration-slider-main">
              <div className="tp-integration-slider-item">
                <img src="/img/integration/integration-8.png" alt="" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 mb-60">
              <div className="tp-blog-item">
                ...
                <div className="tp-blog-meta d-flex align-items-center">
                  <div className="tp-blog-category category-color-2">
                ...
                <div className="tp-blog-title-box">
                  <a className="tp-blog-title-sm" href="blog-details.html">
                    6 Tips for Personal Selling that Guarantee Success in 2023
                  </a>
                </div>
                <div className="tp-blog-author-info-box d-flex align-items-center">
                  <div className="tp-blog-avata">
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 mb-60">
              <div className="tp-blog-item">
                ...
                <div className="tp-blog-title-box">
                  <a className="tp-blog-title-sm" href="blog-details.html">
                    8 Things About Web Design Your Boss Wants To Know
                  </a>
                </div>
                <div className="tp-blog-author-info-box d-flex align-items-center">
                  <div className="tp-blog-avata">
