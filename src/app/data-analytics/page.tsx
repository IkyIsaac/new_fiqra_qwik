    ...
    <main className="fix">
      <div className="tp-hero__area tp-hero__pl-pr">
        <div className="tp-hero__bg p-relative">
          ...
          <div className="tp-hero-shape">
            <img
              className="tp-hero-shape-1"
              src="/img/hero/hero-line-shape.png"
              alt=""
            />
            <img
              className="tp-hero-shape-2"
              src="/img/hero/hero-line-shape-2.png"
              alt=""
            />
          </div>
      ...
      <div className="tp-feature__area tp-feature__pt-pb pt-165 pb-170 p-relative">
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div
              className="col-xl-6 wow tpfadeUp"
              data-wow-duration=".9s"
              data-wow-delay=".2s"
            >
          ...
          <div className="row">
            ...
            >
              <div id="divtest" className="tp-feature__item">
                ...
                <h3 className="tp-feature__title-sm">
            ...
            >
              <div className="tp-about__right">
                ...
                <div className="tp-about__list">
                  <ul>
                    <li>
                      <i className="fal fa-check"></i>Various analysis options.
                    </li>
                    <li>
                      <i className="fal fa-check"></i>Page Load (time, size,
                      number of requests).
                    </li>
                    <li>
                      <i className="fal fa-check"></i>Big data analysis.
                    </li>
                  </ul>
                </div>
          ...
          <div className="row">
            ...
            >
              <div className="tp-service__item mb-30">
                ...
                <div className="tp-service__content">
                  <h3 className="tp-service__title-sm tp-orange-color">
                    <a href="service-details.html">AI Data Analysis</a>
                  </h3>
                  <p>
            ...
            >
              <div className="tp-service__item mb-30">
                ...
                <div className="tp-service__content">
                  <h3 className="tp-service__title-sm tp-purple-color">
                    <a href="service-details.html">Data Visualization</a>
                  </h3>
                  <p>
                    Lorem Ipsum is simply dummy text <br />
                    of the printing
            ...
            >
              <div className="tp-service__item mb-30">
                ...
                <div className="tp-service__content">
                  <h3 className="tp-service__title-sm tp-green-color">
                    <a href="service-details.html">Business Intelligence</a>
                  </h3>
                  <p>
                    Lorem Ipsum is simply dummy text <br />
                    of the printing
            ...
            >
              <div
                ...
                data-background="/img/service/sv-bg.jpg"
              >
                ...
                <div className="tp-service__dashdboard-sm-img">
                  <img
                    ...
                    data-wow-duration=".9s"
                    data-wow-delay=".7s"
                    src="/img/service/sv-dashbord.png"
                    alt=""
                  />
                </div>
              </div>
                  ...
                  <div className="swiper-wrapper">
                      ...
                      <div className="tp-project__slider-wrapper">
                        <div className="tp-project__item d-flex align-items-center">
                          <div className="tp-project__thumb">
                            <img src="/img/project/project-img-2.jpg" alt="" />
                          </div>
                          <div className="tp-project__content">
                            <div className="tp-project__brand-icon">
                              <img
                                src="/img/project/project-brand-1.png"
                                alt=""
                              />
                            </div>
                    ...
                    >
                      <div className="tp-project__slider-wrapper">
                        <div className="tp-project__item d-flex align-items-center">
                          <div className="tp-project__thumb">
                            <img src="/img/project/project-img-1.jpg" alt="" />
                          </div>
                          <div className="tp-project__content">
                            <div className="tp-project__brand-icon">
                              <img
                                src="/img/project/project-brand-2.png"
                                alt=""
                              />
                            </div>
                            <div className="tp-project__title-box">
                              <h4 className="tp-project__title-sm">
                                <a href="project-details.html">3d Design</a>
                              </h4>
                              <p>
                                Excepteur sint occaecat cupidatat officia non
                                proident, sunt in culpa qui deserunt mollit anim
                    ...
                    >
                      <div className="tp-project__slider-wrapper">
                        <div className="tp-project__item d-flex align-items-center">
                          <div className="tp-project__thumb">
                            <img src="/img/project/project-img-3.jpg" alt="" />
                          </div>
                          <div className="tp-project__content">
                            <div className="tp-project__brand-icon">
                              <img
                                src="/img/project/project-brand-4.png"
                                alt=""
                              />
                            </div>
                            <div className="tp-project__title-box">
                              <h4 className="tp-project__title-sm">
                                <a href="project-details.html">App Design</a>
                              </h4>
                              <p>
                                Excepteur sint occaecat cupidatat officia non
                                proident, sunt in culpa qui deserunt mollit anim
                    ...
                    >
                      <div className="tp-project__slider-wrapper">
                        <div className="tp-project__item d-flex align-items-center">
                          <div className="tp-project__thumb">
                            <img src="/img/project/project-img-4.jpg" alt="" />
                          </div>
                          <div className="tp-project__content">
                            <div className="tp-project__brand-icon">
                              <img
                        ...
                        <div className="col-xl-7 col-lg-7">
                          <div className="tp-testimonial__left-item p-relative">
                            <div className="tp-testimonial__logo">
                              <img
                                src="/img/testimonial/testi-logo-up-3.png"
                                alt=""
                              />
                            </div>
                            <div className="tp-testimonial__content z-index">
                              <p>
                                “Business growth is a point a business reaches
                                where it expands and requires more avenues to
                                generate a profit. This can happen when a
                      ...
                      <div className="row gx-0">
                        <div className="col-xl-7 col-lg-7">
                          <div className="tp-testimonial__left-item p-relative">
                            <div className="tp-testimonial__logo">
                              <img
                                src="/img/testimonial/testi-logo-up-4.png"
                                alt=""
                              />
                            </div>
                            <div className="tp-testimonial__content z-index">
                              <p>
                                “Market penetration. The aim of this strategy is
                                to increase sales of existing products or
                                services on existing markets, and thus to
                      ...
                      <div className="row gx-0">
                        <div className="col-xl-7 col-lg-7">
                          <div className="tp-testimonial__left-item p-relative">
                            <div className="tp-testimonial__logo">
                              <img
                                src="/img/testimonial/testi-logo-up-5.png"
                                alt=""
                              />
                            </div>
                            <div className="tp-testimonial__content z-index">
                              <p>
                                “Every new business and start-up, big or small,
                                goes through the five stages of business growth.
                                These phases include existence, survival,
                      ...
                      <div className="row gx-0">
                        <div className="col-xl-7 col-lg-7">
                          <div className="tp-testimonial__left-item p-relative">
                            <div className="tp-testimonial__logo">
                              <img
                                src="/img/testimonial/testi-logo-up-6.png"
                                alt=""
                              />
                            </div>
                            <div className="tp-testimonial__content z-index">
                              <p>
                                “Calculating the growth rates of various metrics
                                and then comparing them to one another gives you
                                a more complete picture of your business’s
                                trajectory.”
                              </p>
                            </div>
                            <div className="tp-testimonial__author-info z-index">
                      ...
                      <div className="row gx-0">
                        <div className="col-xl-7 col-lg-7">
                          <div className="tp-testimonial__left-item p-relative">
                            <div className="tp-testimonial__logo">
                              <img
                                src="/img/testimonial/testi-logo-up-1.png"
                                alt=""
                              />
                            </div>
                            <div className="tp-testimonial__content z-index">
                              <p>
                                ...
                                implementing these tips can put your business in
                                the best position to succeed and grow.”
                              </p>
                            </div>
                            <div className="tp-testimonial__author-info z-index">
                              <span>Benjamin Evalent</span>
                      ...
                      <div className="row gx-0">
                        <div className="col-xl-7 col-lg-7">
                          <div className="tp-testimonial__left-item p-relative">
                            ...
                            <div className="tp-testimonial__content z-index">
                              <p>
                                “Small businesses can quickly adapt and respond
                                to customers’ needs. This agility can give them
                                an advantage over larger businesses.”
                              </p>
                            </div>
                            <div className="tp-testimonial__author-info z-index">
                              <span>Benjamin Evalent</span>
          ...
          <div className="row">
            ...
            <div className="col-xl-7 col-lg-7 order-0 order-lg-2">
              <div className="tp-rank__wrapper p-relative">
                <div
                  className="tp-rank__circle-shape-1 d-none d-sm-block wow tpfadeUp"
                  data-wow-duration=".9s"
                  data-wow-delay=".3s"
                >
                ...
                <div
                  className="tp-rank__circle-shape-2 d-none d-sm-block wow tpfadeLeft"
                  data-wow-duration=".9s"
                  data-wow-delay=".5s"
                >
                ...
                <div
                  className="tp-rank__circle-shape-3 d-none d-sm-block wow tpfadeRight"
                  data-wow-duration=".9s"
                  data-wow-delay=".4s"
                >
                ...
                <div
                  className="tp-rank__circle-shape-4 d-none d-sm-block wow tpfadeIn"
                  data-wow-duration=".9s"
                  data-wow-delay=".7s"
                >
                ...
                <div
                  className="tp-rank__circle-shape-5 d-none d-sm-block wow tpfadeUp"
                  data-wow-duration=".9s"
                  data-wow-delay=".9s"
                >
                  <img src="/img/rank/black-sm-circle.png" alt="" />
                ...
                <div
                  className="tp-rank__circle-shape-6 d-none d-sm-block wow tpfadeUp"
                  data-wow-duration=".9s"
                  data-wow-delay=".2s"
                >
                  <img src="/img/rank/black-sm-circle.png" alt="" />
                ...
                <div
                  className="tp-rank__circle-shape-7 d-none d-sm-block wow tpfadeIn"
                  data-wow-duration=".9s"
                  data-wow-delay="1s"
                >
                  <img src="/img/rank/black-sm-circle.png" alt="" />
                ...
                <div className="tp-rank__bg-shape">
                  <img
                    ...
                    data-wow-duration=".9s"
                    data-wow-delay="1.2s"
                    src="/img/rank/rank-bg-shape.png"
                    alt=""
                  />
                </div>
                <div
                ...
                >
                  <div className="tp-rank__item active p-relative z-index">
                    <div className="tp-rank__cup">
                      <span>
                        <img src="/img/rank/rank-cup.png" alt="" />
                      </span>
                    </div>
                    ...
                    <div className="tp-rank__company">
                      <span>
                        <img src="/img/rank/amazon.png" alt="" />
                      </span>
                    </div>
                  ...
                  <div className="tp-rank__item p-relative z-index">
                    ...
                    <div className="tp-rank__company">
                      <span>
                        <img src="/img/rank/walmart.png" alt="" />
                      </span>
                    </div>
                    <div className="tp-rank__company-info">
                  ...
                  <div className="tp-rank__item p-relative">
                    ...
                    <div className="tp-rank__company">
                      <span>
                        <img src="/img/rank/shopify.png" alt="" />
                      </span>
                    </div>
                    <div className="tp-rank__company-info">
