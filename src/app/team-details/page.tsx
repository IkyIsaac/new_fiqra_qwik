                ...
                <div className="row">
                  <div className="col-xl-4 col-lg-4 col-md-4">
                    <div className="team-details-img-box text-center">
                      <div className="team-details-img">
                        <img src="/img/team/team-details-1.jpg" alt="" />
                      </div>
                      ...
                      <div className="team-details-work-location">
                        <span>
                          ...
                          >
                            <path
                              d="M1 6.70031C1 3.55211 3.74226 1 7.125 1C10.5077 1 13.25 3.55211 13.25 6.70031C13.25 9.82383 11.2951 13.4687 8.24506 14.7721C7.53404 15.076 6.71596 15.076 6.00494 14.7721C2.95489 13.4687 1 9.82383 1 6.70031Z"
                              stroke="#5F6168"
                              stroke-width="1.5"
                            />
                            <path
                              d="M8.875 7.12524C8.875 8.09174 8.0915 8.87524 7.125 8.87524C6.1585 8.87524 5.375 8.09174 5.375 7.12524C5.375 6.15875 6.1585 5.37524 7.125 5.37524C8.0915 5.37524 8.875 6.15875 8.875 7.12524Z"
                              stroke="#5F6168"
                              stroke-width="1.5"
                            />
                          </svg>
                  ...
                  <div className="col-xl-8 col-lg-8 col-md-8">
                    <div className="team-details-info-box">
                      <h3 className="team-details-client-title">
                        Imdat Cimsit
                      </h3>
            ...
            <div className="col-xl-8 col-lg-10">
              <div className="team-details-text-wrapper pt-80">
                <div className="team-details-text">
                  <h4 className="team-details-title">About Imdat Cimsit</h4>
                  <p>
                ...
                <div className="team-details-feature-list">
                  ...
                  <p>
                    ...
                    molestie nunc non blandit massa enim nec. Ac feugiat sed
                    lectus vestibulum mattis ullamcorper velit. Posuere morbi
                    leo urna molestie.
                  </p>
                </div>
              </div>
