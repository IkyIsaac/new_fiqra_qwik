...
import ImgBreadcrumbSub2 from '~/media/assets/img/breadcrumb/breadcrumb-sub-2.png?jsx';
import ImgBreadcrumbSub3 from '~/media/assets/img/breadcrumb/breadcrumb-sub-3.png?jsx';
import ImgProjectInner2 from '~/media/assets/img/project/project-inner-2.jpg?jsx';import { component$ } from '@builder.io/qwik';
   ...
   <div class="container">
      ...
      <div class="row grid">
         <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 grid-item  cat1 cat4 cat3 cat5">
            <div class="inner-project-item mb-30">
               <div class="inner-project-img fix p-relative">
                  <img class="w-100" src="/assets/img/project/project-inner-1.jpg" alt=""/>
         ...
         <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 grid-item  cat4 cat2 cat1 ">
            <div class="inner-project-item  mb-30">
               <div class="inner-project-img fix p-relative">
                  <ImgProjectInner2 alt=""/>
                  <div class="inner-project-brand">
                     <img class="w-100" src="/assets/img/project/project-inner-brand-2.png" alt=""/>
                  </div>
               </div>
               <div class="inner-project-content">
         ...
         <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 grid-item  cat3 cat4 cat5 ">
            <div class="inner-project-item mb-30">
               <div class="inner-project-img fix p-relative">
                  <img class="w-100" src="/assets/img/project/project-inner-3.jpg" alt=""/>
                  <div class="inner-project-brand">
         ...
         <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 grid-item  cat4 cat2 cat1">
            <div class="inner-project-item mb-30">
               <div class="inner-project-img fix p-relative">
                  <img class="w-100" src="/assets/img/project/project-inner-5.jpg" alt=""/>
                  <div class="inner-project-brand">
                     <img src="/assets/img/project/project-inner-brand-5.png" alt=""/>
                  </div>
               </div>
               <div class="inner-project-content">
                  <span class="inner-project-category-title">Design Wok, Illustration</span>
         ...
         <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 grid-item  cat1 cat2 cat3 cat5">
            <div class="portfolio__single">
               <div class="portfolio__img">
                  <div class="inner-project-item mb-30">
                     <div class="inner-project-img fix p-relative">
                        <img class="w-100" src="/assets/img/project/project-inner-4.jpg" alt=""/>
                        <div class="inner-project-brand">
         ...
         <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 grid-item  cat4 cat2 cat1">
            <div class="inner-project-item mb-30">
               <div class="inner-project-img fix p-relative">
                  <img class="w-100" src="/assets/img/project/project-inner-7.jpg" alt=""/>
                  <div class="inner-project-brand">
                     <img src="/assets/img/project/project-inner-brand-5.png" alt=""/>
                  </div>
               </div>
         ...
         <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 grid-item  cat1 cat2 cat3 cat5">
            <div class="portfolio__single">
               <div class="portfolio__img">
                  <div class="inner-project-item mb-30">
                     <div class="inner-project-img fix p-relative">
                        <img class="w-100" width="350" height="323" src="/assets/img/project/teya.png" alt=""/>
                        <div class="inner-project-brand">
                           <img src="/assets/img/project/project-inner-brand-4.png" alt=""/>
                        </div>
                     </div>
